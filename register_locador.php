...
<body style="background-color: #55407d;">
  ...
  <div class="container" >
    <div class="card card-register mx-auto mt-4 mb-4 col-md-8" >
      ...
      <?php endif; ?>
        ...
        <form action="cargar_registro.php?rol=<?php echo $rol; ?>" method="post" enctype="multipart/form-data" class="form-a">
            ...
            <div class="form-row">
              ...
              <div class="col-md-6">
                ...
                <label for="nombre">Nombre/s</label>
                  ...
                  <input type="text" name="direccion" class="form-control" placeholder="Ingrese Dirección" required="required">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <label for="telefono">Telefono</label>
                  <input type="text" name="telefono" class="form-control" placeholder="Ingrese número de telefono" required="required" autofocus="autofocus">
            </div>
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  <input type="password" name="contraseqa" class="form-control" placeholder="Ingrese contraseña" required="required">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
                  <label for="vercontraseqa">Confirmar contraseña</label>
                  <input type="password" name="vercontraseqa" class="form-control" placeholder="Vuelva a ingresar contraseña" required="required">
                </div>
              </div>
            </div>
          </div>
          ...
          <input type="submit" class="btn btn-primary btn-block col-md-4 mx-auto" style="background-color: #adc867;" name="ini" value="Registrar"></input>
        </form>
